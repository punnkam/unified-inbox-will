...
export const InboxLandingView = ({
  ...
  data: Conversation[];
  handleTabChange: (table: ConversationTable, value: boolean) => void;
  handleFilterChange: (
  ...
  handleMarkUnread: (table: ConversationTable) => void;
  handleMarkDone: (table: ConversationTable) => void;
  handleAssign: (table: ConversationTable, member: Member) => void;
                      ...
                      <div className="relative">
                        <p
                          className={clsx(
                            ...
                            // Add active styles
                            table
                              .getColumn("messageStatus")
                              ?.getFilterValue() === false && "text-brand"
                          )}
                        >
                          Todo
                          <span
                      ...
                      <div className="relative">
                        <p
                          className={clsx(
                            ...
                            table
                              .getColumn("messageStatus")
                              ?.getFilterValue() === true && "text-brand"
                          )}
                        >
                          Done
                        </p>
