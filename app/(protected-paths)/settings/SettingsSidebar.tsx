    ...
    return (
        <div className='h-screen bg-primary-subtle w-[280px] border-e stroke-primary overflow-y-auto px-2'>
            ...
            <SettingsSideBarOption
                path='/settings/teams'
                name='Teams'
                selected={pathname === "/settings/teams"}
            />
            <SettingsSideBarOption
            ...
            <Accordion
                type='single'
                collapsible
                defaultValue='connected-channels'
            >
                <AccordionItem value='connected-channels'>
                    ...
                    <AccordionContent className='pb-0 pt-2'>
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/connected-channels/airbnb"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            name='PMS'
                            selected={
                                pathname === "/settings/connected-channels/pms"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/connected-channels/email"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/connected-channels/whatsapp"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            name='SMS'
                            selected={
                                pathname === "/settings/connected-channels/sms"
                            }
                        />
                    </AccordionContent>
                </AccordionItem>
            ...
            <Accordion
                type='single'
                collapsible
                defaultValue='inbox-configuration'
            >
                <AccordionItem value='inbox-configuration'>
                    ...
                    <AccordionContent className='pb-0 pt-2'>
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/inbox-configuration/general"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/inbox-configuration/ai-settings"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/inbox-configuration/reservation-labels"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/inbox-configuration/conversation-tags"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            selected={
                                pathname ===
                                "/settings/inbox-configuration/saved-replies"
                            }
                        />
                        <SettingsSideBarOption
                            ...
                            name='SLA'
                            selected={
                                pathname === "/settings/inbox-configuration/sla"
                            }
                        />
                    </AccordionContent>
                </AccordionItem>
